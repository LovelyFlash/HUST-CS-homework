...
void print_beautiful_sudoku(int board[N][N])
{
    ...
    // 打印图例说明
    printf("\n🎨 颜色区域说明:\n");
    setConsoleColor(1, 15); printf("  深蓝色 "); resetConsoleColor(); printf(" - 左上窗口区域 (2-4行2-4列)\n");
    setConsoleColor(2, 15); printf("  深绿色 "); resetConsoleColor(); printf(" - 右下窗口区域 (6-8行6-8列)\n");
    setConsoleColor(5, 15); printf("  紫色   "); resetConsoleColor(); printf(" - 撇对角线区域\n");
    setConsoleColor(6, 0);  printf("  黄色   "); resetConsoleColor(); printf(" - 偶数宫格区域\n");
    setConsoleColor(3, 0);  printf("  青色   "); resetConsoleColor(); printf(" - 奇数宫格区域\n");
}
